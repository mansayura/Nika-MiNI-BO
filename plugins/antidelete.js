...
const { getAnti, setAnti, initializeAntiDeleteSettings } = require('../lib/data/antidel');
...
• \`\`.antidelete set gc\`\` – Active/Désactive groupes
• \`\`.antidelete set dm\`\` – Active/Désactive DM
• \`\`.antidelete set all\`\` – Active pour tous
