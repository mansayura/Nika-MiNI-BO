const {
    ...
    proto
} = require('baileys-x')  // <-- මෙතන '@whiskeysockets/baileys' වෙනුවට 'baileys-x' යොදන්න
...
if (!fs.existsSync(__dirname + '/lib/creds.json')) {
    if (config.SESSION_ID) {
      const sessdata = config.SESSION_ID.replace("𝐍𝐈𝐊𝐀 𝐌𝐈𝐍𝐈 𝐌𝐃=", "")
...
text: "*🎬 𝐍𝐈𝐊𝐀 𝐌𝐈𝐍𝐈 𝐌𝐃  successfully connected* ✓\n\n\n> ◦ *Official GitHub* - ```repo link```\n> ◦ ᴊᴏɪɴ ᴏᴜʀ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ᴠɪᴀ ᴛʏᴘᴇ: .joinsup\n*🎬 𝐍𝐈𝐊𝐀 𝐌𝐈𝐍𝐈 𝐌𝐃 ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ*\n*ᴄʀᴇᴀᴛᴇᴅ ʙʏ • SAYURA*",
contextInfo: {
externalAdReply: {
title: "🎬 𝐍𝐈𝐊𝐀 𝐌𝐈𝐍𝐈 𝐌𝐃 🎬\nSuccessfully Connected !",	
thumbnailUrl: 'https://i.postimg.cc/9FkhDKYR/file-00000000022461faa976f5570799fae2.png',
sourceUrl: "",
mediaType: 1,
...
//==================================================================
  ...
  //SORY BRO SETTINGS PLUGINS NOT 💔👨‍🔧💬 IAM NIKA
...
externalAdReply: { 
title: '☈☟𝐍𝐈𝐊𝐀 𝐌𝐈𝐍𝐈 𝐌𝐃 𝗩1️⃣',
body: 'A fast mini bot ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ',
mediaType: 1,
sourceUrl: "https://wa.me/94743826406" ,
thumbnailUrl: 'https://i.postimg.cc/9FkhDKYR/file-00000000022461faa976f5570799fae2.png' ,
renderLargerThumbnail: false,
...
app.get("/", (req, res) => {
res.send("📟 NIKA MINI successfully!");
});
